...
from octoprint_firmwareupdater.methods import custom
...
class FirmwareupdaterPlugin(octoprint.plugin.BlueprintPlugin,
	...
	def initialize(self):
		...
		self._flash_prechecks = dict(avrdude=avrdude._check_avrdude, bossac=bossac._check_bossac, dfuprogrammer=dfuprog._check_dfuprog, lpc1768=lpc1768._check_lpc1768, stm32flash=stm32flash._check_stm32flash, custom=custom._check_custom)
		self._flash_methods = dict(avrdude=avrdude._flash_avrdude, bossac=bossac._flash_bossac, dfuprogrammer=dfuprog._flash_dfuprog, lpc1768=lpc1768._flash_lpc1768, stm32flash=stm32flash._flash_stm32flash, custom=custom._flash_custom)
