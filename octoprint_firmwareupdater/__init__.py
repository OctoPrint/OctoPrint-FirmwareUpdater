    ...
    def get_settings_defaults(self):
        return {
            ...
            "_profiles": {
                ...
                "avrdude_prusamk3s_lang": False,
                "avrdude_prusamk3s_lang_commandline": "{avrdude} -v -q -p {mcu} -c arduino -P {port} -D -C {conffile} -b {baudrate} {disableverify} -U flash:w:1:{firmware}:i",
                "bootcmdr_path": None,
